...
Raspberry Pi 3 を使った少しおしゃれなデジタル所在表です。
数字キーで「在室」，「帰宅」などの所在表示を切り替えられます。
小型化のためにGPIO接続の小型モニタを使用しています。
また，室外設置を考慮しているので無線テンキーを使用しています。
...
| ディスプレイ | Kuman 3.5インチモニタ（GPIO, 480x320）|
