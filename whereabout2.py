			...
			for event in device.read_loop():
				if event.type == evdev.ecodes.EV_KEY:
					if event.code == evdev.ecodes.KEY_KP0:
						...
						subprocess.call(['cp /home/arumami88/www/home.html /home/arumami88/www/index.html'], shell=True)
					if event.code == evdev.ecodes.KEY_KP1:
						driver.get(key1_webpage)
						subprocess.call(['cp /home/arumami88/www/vacation.html /home/arumami88/www/index.html'], shell=True)
					if event.code == evdev.ecodes.KEY_KP2:
						driver.get(key2_webpage)
						subprocess.call(['cp /home/arumami88/www/blank.html /home/arumami88/www/index.html'], shell=True)
					if event.code == evdev.ecodes.KEY_KP3:
						driver.get(key3_webpage)
						subprocess.call(['cp /home/arumami88/www/trip.html /home/arumami88/www/index.html'], shell=True)
					if event.code == evdev.ecodes.KEY_KP4:
						driver.get(key4_webpage)
						subprocess.call(['cp /home/arumami88/www/afk.html /home/arumami88/www/index.html'], shell=True)
					if event.code == evdev.ecodes.KEY_KP5:
						driver.get(key5_webpage)
						subprocess.call(['cp /home/arumami88/www/blank.html /home/arumami88/www/index.html'], shell=True)
					if event.code == evdev.ecodes.KEY_KP6:
						driver.get(key6_webpage)
						subprocess.call(['cp /home/arumami88/www/meeting.html /home/arumami88/www/index.html'], shell=True)
					if event.code == evdev.ecodes.KEY_KP7:
						driver.get(key7_webpage)
						subprocess.call(['cp /home/arumami88/www/room.html /home/arumami88/www/index.html'], shell=True)
					if event.code == evdev.ecodes.KEY_KP8:
						driver.get(key8_webpage)
						subprocess.call(['cp /home/arumami88/www/blank.html /home/arumami88/www/index.html'], shell=True)
					if event.code == evdev.ecodes.KEY_KP9:
						driver.get(key9_webpage)
						subprocess.call(['cp /home/arumami88/www/meal.html /home/arumami88/www/index.html'], shell=True)
